...
function setDataOnModal() {
    ...
    $('<p>').attr('id', 'phi_firstPara').appendTo($div);
    $('#phi_firstPara').innerHTML = "I have prescribed nirmatrelvir in comibination with ritonavir (Paxlovid&reg;) to treat your COVID infection";
